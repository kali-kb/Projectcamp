	...
	@section('content')
	    ...
	    <div class="flex flex-wrap">
		  <div class="max-w-md px-8 py-4 mx-auto mt-16 border bg-white rounded-lg shadow-sm dark:bg-gray-800">
		    ...
		    <p class="mt-2 text-gray-600 dark:text-gray-200 text-6xl">-</p>
		  </div>
		  <div class="max-w-md px-8 py-4 mx-auto mt-16 border bg-white rounded-lg shadow-sm dark:bg-gray-800">
				...
				<div class="bg-green-500 rounded max-w-fit m-1">
				  <div class="items-center space-y-2 space-x-2 py-3">
				    <div class="flex mx-2 text-white">
				      ...
				      <span class="mx-2 text-white">{{ $project->job->job_title }}</span>
				    </div>
				    <div class="text-white items-center space-x-1 flex">
				      ...
				      <span class="text-sm font-bold mt-[2px]">{{ $project->job->price }}</span>
				    </div>
				    <div id="{{ $project->id }}" class="flex items-center">
				      <button id="button" class="bg-white hover:scale-105 duration-150 px-2 py-1 mx-2 rounded text-green-500 text-sm font-bold">Submit Project</button>
