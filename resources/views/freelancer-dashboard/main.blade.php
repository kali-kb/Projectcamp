@extends('freelancer-dashboard.dashboard')
	@section('content')
				...
				<div class="bg-green-500 rounded max-w-fit m-1">
				  <div class="items-center space-y-2 space-x-2 py-3">
				    ...
				    <div id="{{ $project->job->job_id }}" class="flex items-center">
				      <button id="{{ $project->job->job_id }}" class="submit-button bg-white hover:scale-105 duration-150 px-2 py-1 mx-2 rounded text-green-500 text-sm font-bold">Submit Project</button>
		...
		<script type="text/javascript">
            ...
            // var button = document.getElementByClassName("submit-button")
