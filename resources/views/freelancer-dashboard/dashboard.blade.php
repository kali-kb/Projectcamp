...
<aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div>
        ...
        <ul class="space-y-2 tracking-wide mt-8">
            <li>
                <a href="/fx/dashboard" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-black">
                    <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                        <path d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z" class="fill-current text-green-200 group-hover:text-green-300"></path>
                        ...
                        <path d="M13 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-1Z" class="fill-current text-green-200 group-hover:text-green-300"></path>
                    </svg>
                    <span class="-mr-1 font-medium text-[#b1ff00] group-hover:text-green-300">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="/fx/dashboard/search" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span class="group-hover:text-gray-700">Search Jobs</span>
                </a>
            </li>
            <li>
                <a href="/fx/dashboard/saved-jobs" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span class="group-hover:text-gray-700">Saved jobs</span>
                </a>
            </li>

            <li>
                <a href="/fx/payout" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 group-hover:text-[#b1ff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
