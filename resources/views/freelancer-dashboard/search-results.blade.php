    ...
    <div class="my-5 overflow-hidden">
		...
		@if(count($results) > 0)
		    @foreach($results as $result)
		        <div class="h-auto sm:w-10/12 w-6/12 border shadow-sm rounded flex sm:items-center sm:flex-row flex-col justify-between mx-auto mt-10">
		          <div class="flex sm:flex-row flex-col items-center mx-4 space-x-3 my-3 sm:my-5">
		            ...
		            <div class="flex flex-col">
		              ...
		              <div class="inline">
		                ...
		                <span class="font-bold text-sm">${{ $result->price }}/hr</span>
		                ...
		                <span class="font-bold text-sm">{{ $result->client->location }}</span>
		              </div>
		            </div>
