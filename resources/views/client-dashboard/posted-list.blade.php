...
@section("content")
	...
	@foreach($posted_jobs as $job)
		<div class="mt-10 flex h-auto flex-col justify-between rounded border shadow-sm sm:flex-row sm:items-center">
		  <div class="mx-4 my-3 flex flex-col items-center space-x-3 sm:my-5 sm:flex-row">
		    ...
		    <div class="flex flex-col">
		      ...
		      <div class="flex sm:flex-row flex-col items-center">
		        ...
		        <span class="text-sm font-bold">${{ $job->price }}</span>
		        ...
		        <div class="mx-4 flex sm:flex-row items-center space-x-2">
			      ...
			      @else
				      <span class="text-sm font-bold text-[#b1ff00]">{{ count($job->proposals) }} Proposal</span>
			      @endif    
		        </div>
		      </div>
		    </div>
		  ...
		  <a href="/cx/posted-jobs/{{$job->id}}/proposals">
